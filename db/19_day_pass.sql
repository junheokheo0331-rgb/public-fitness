-- ============================================================
-- GymLink — 19_day_pass.sql
-- 일일권 판매 조건과 결제 후 출입 자격 발급.
-- ============================================================

alter table public.price_plans add column if not exists valid_days int;
alter table public.price_plans add column if not exists metadata jsonb not null default '{}'::jsonb;
...
select 'GymLink day pass ready' as result;
